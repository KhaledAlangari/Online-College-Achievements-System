  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-refresh logo-small"></span>
        <nav><h4><a href="update_records.php">Update Records</a></h4></nav>
      <p>Update performance records in database</p>
    </div>
    
     
      
      <div class="col-sm-4">
      <span class="glyphicon glyphicon-chevron-left logo-small" style="margin-top:200px"></span>
