...
<?php 
	if (isset($_GET['edit'])) {
		$i = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM college WHERE i='$i'");
...
<?php endif ?>
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="edit_college.php?edit=<?php echo $row['i']; ?>" class="edit_btn" >Edit</a>
			</td>
			<td>
				<a href="college_db.php?del=<?php echo $row['i']; ?>" class="del_btn">Delete</a>
			</td>
		</tr>
	<?php } ?>
</table>
    ...
    <form method="post" action="college_db.php" >
		...
		<div class="input-group">
			...
			<input type="text" name="achievement" value="<?php echo $achievement; ?>">
		</div>
        	<div class="input-group">
